...
import { ConfigType } from '../../utils/validator';
...
const config: Map<string, ConfigType> = [
    ...
    {
        key: 'enteralProtein',
        message: '肠内营养性氨基酸0-500g',
        validator: (v) => v >= 0 && v < 500,
    },
    {
        key: 'parenteralProtein',
        message: '肠内营养性氨基酸0-500g',
        validator: (v) => v >= 0 && v < 500,
    },
    {
...
export function validate(record: IRecord): string {
