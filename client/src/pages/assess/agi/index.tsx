    ...
    return (
        <View style={{ margin: '5PX' }}>
            <View className="gridcontainer">
                ...
                <View style={odd}>Ⅰ</View>
                <View style={odd}>有明确病因、胃肠道功能部分受损</View>
                <View style={odd}>
                    胃肠道症状常常发生在机体经历一个打击（如手术、休克等）之后，具有暂时性和自限性的特点
                </View>
                <View style={odd}>术后早期恶心、呕吐；休克早期肠鸣音消失、肠动力减弱</View>

                <View style={even}>Ⅱ</View>
                <View style={even}>
                ...
                <View style={odd}>Ⅲ</View>
                <View style={odd}>给予干预处理后，胃肠功能仍不能恢复，整体状况没有改善</View>
                <View style={odd}>
                ...
                <View style={even}>Ⅳ</View>
                <View style={even}>AGI逐步进展，MODS和休克进行性恶化，随时有生命危险</View>
                <View style={even}>一般状况急剧恶化，伴远隔器官功能障碍</View>
                <View style={even}>
